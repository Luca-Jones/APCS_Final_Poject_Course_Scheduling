            ...
            if (course._name == student[i]._course_requests[j]):
                ...
                if course._terms_blocking:
                    ...
                    if course._terms_blocking[0] == course._name:
                        '''didItWork = place_reference(0, 3, i, course)
                        didItWork2 = place_reference(4, 7, i, get_course(course._terms_blocking[1]))
                        if didItWork2 and didItWork:'''
                        place(0, 3, i, course)
...
print("Sum of percent of students with 100%, 1 not filled and 2 not filled no alts. ", two_or_less_missing(student) // 0.001 / 10, " % ")
print("Sum of percent of students with 100%, 1 not filled and 2 not filled with alt", two_or_less_missing_alt(student) // 0.001 / 10, " % ")
print("Percent of students with 3-8 courses not fulfilled (alt or requested)", (1 - two_or_less_missing(student)) // 0.001 / 10, " % ")



print()

print("Percent of students with 100 percent of requested courses, not alt. ", students_with_eight_courses(student) // 0.001 / 10, " % ")
print("Percent of students with 1 requested course not fulfilled, no alts. ", students_missing_one_course(student) // 0.001 / 10, " % ")

print("Percent of students with 100 percent of requested courses, including alts. ", students_with_eight_courses_alt(student) // 0.001 / 10, " % ")
print("Percent of students with 1 requested course not fulfilled,  including alts. ", students_missing_one_course_alt(student) // 0.001 / 10, " % ")
...
for STUDENT_ID in range(SID, SID + 1, 1):
    print("\nStudent ", STUDENT_ID, ":")
